    ...
    const testimonials = [
        {
            ...
            rating: 5,
            text: "TicketMax made it so easy to find and book tickets for my favorite concerts. The mobile tickets are a game-changer!"
        },
        {
            name: "Michael Chen",
            ...
            rating: 5,
            text: "As an event organizer, TicketMax has streamlined our entire ticketing process. The analytics and QR scanning features are fantastic."
        },
        {
            name: "Emma Davis",
            ...
            <div className="container mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                        Join thousands of satisfied customers who trust TicketMax
                            ...
                            <CardContent className="p-6">
                                ...
                                <div className="flex items-center">
                                    <img
                                        ...
                                        className="w-12 h-12 object-cover rounded-full mr-4 border-2 border-purple-500/30"
                                    />
                                    <div>
