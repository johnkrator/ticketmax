            ...
            <div className="container mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                        Discover the hottest events happening near you. From concerts to conferences, we've got
                        something for
                        everyone.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {featuredEvents.map((event) => (
                        <Link key={event.id} to={`/events/${event.id}`}>
                            <Card
                                className="bg-white/5 backdrop-blur-md border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 group cursor-pointer h-[30rem] flex flex-col overflow-hidden p-0">
                                <div className="relative h-48 w-full overflow-hidden flex-shrink-0 rounded-t-lg">
                                    <img
                ...
                <div className="text-center mt-12">
                    <Link to="/events">
                        <Button
                            size="lg"
                            variant="outline"
                            className="border-white/30 text-[#561888] hover:text-white cursor-pointer hover:bg-white/10 px-8 py-4 text-lg rounded-full bg-transparent"
                        >
                            View All Events
                        </Button>
                    </Link>
